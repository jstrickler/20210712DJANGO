...
# def home(request):
#     return HttpResponse("Welcome to Splashing with dolphins")

# example with template (normal Django approach)
# def home(request):
#     context = { 'message': "Welcome to Splashing with dolphins" }
#     return render(request, 'dolphins/home.html', context)
